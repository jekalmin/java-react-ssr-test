...
public class V8ScriptTemplateView extends AbstractUrlBasedView {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        V8Array parameters = new V8Array(v8).push(modelAttributes);
        V8Object json = v8.getObject("JSON");
        String modelString = json.executeStringFunction("stringify", parameters);

        Object html = v8.executeJSFunction(this.renderFunction, template, modelString);
